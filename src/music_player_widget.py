...
class MainWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.tabWidget.addTab(self.tableView, u'Playlist')
        self.tabWidget.addTab(self.tableViewFav, u'Mi coleccion')
    ...
    def addMusics(self, filePaths=[], favFilePaths=[]):
        if not len(filePaths) and not self.isImporting:
            filePaths = QFileDialog.getOpenFileNames(self, u'Abrir', self.lastOpenedPath, u'Archivo de audio (*.mp3 *.wma)')
